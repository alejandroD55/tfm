...
Continuous backtest on cached data only (strict cache check, single run_id, no yfinance):
  python bootstrap_365_days.py --interpret-only --start ... --end ...
  python scripts/run_interpret_pipeline.py --start ... --end ...
